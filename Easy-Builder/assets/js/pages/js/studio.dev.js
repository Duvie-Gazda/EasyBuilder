...
var Element = function Element(htmlVal, cssVal, jsVal, customCssVal, tree) {
...
var elementNew = new Element('', '', '', '', '');

function CreateEditor(htmlContainer, language) {
  require.config({
    paths: {
      vs: "../../../../Easy-Builder/assets/plugins/monaco/min/vs"
    }
  });
  ...
  require(["vs/editor/editor.main"], function () {
    ...
    if (language === "css") {
      ...
      return "".concat(language, " language is not available");
    }
  });
}

function ChangeEditorTheme(id) {
  var themePicker = document.getElementById(id);

  themePicker.onchange = function () {
    var theme = this.options[this.selectedIndex].getAttribute("value");
...
$('#Html-Studio').on('click', function () {
  ...
  data.push(new elementOnPanel('<div>', '', 'shadow-sm border code-monaco-editor-St', 'html-editor', '#html-editor-sub-container')); //addDataByClick('#Html-Studio',data,'#work-table','','work-table');
...
$('#css-Studio').on('click', function () {
  ...
  data.push(new elementOnPanel('<div>', '', 'shadow-sm border code-monaco-editor-St', 'css-editor', '#css-editor-sub-container')); //addDataByClick('#css-Studio',data,'#work-table','','work-table');
...
$('#js-Studio').on('click', function () {
  ...
  data.push(new elementOnPanel('<div>', '', 'shadow-sm border code-monaco-editor-St', 'js-editor', '#js-editor-sub-container')); //addDataByClick('#js-Studio',data,'#work-table','','work-table');
...
$('#send-data-Studio').on('click', function () {
  if (window.editorHTML !== undefined) {
    var htmlEditorValue = window.editorHTML.getValue();
    var data = {
