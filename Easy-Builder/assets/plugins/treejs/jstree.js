...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
		...
		/**
		 * returns the jQuery extended connect UL node inside the instance container. Used internally.
		 * @private
 ...
 */
	...
	$.jstree.defaults.checkbox = {
		...
		cascade				: '',
		/**
		 * This setting controls if checkbox are bound to the general tree selection or to an internal array connecttained by the checkbox plugin. Defaults to `true`, only set to `false` if you know exactly what you are doing.
 ...
 */
	...
	$.jstree.defaults.dnd = {
		...
		copy : true,
		/**
		 * a number indicating how long a node should reconnect hovered while dragging to be opened. Defaults to `500`.
