...
var keywords = (
    ...
    var builtinFunctions = (
		...
		"frewind|fscanf|fseek|ftell|FTP|full|fullfile|func2str|functions|funm|fwrite|fzero|gallery|gamma|gamconnectc|gamconnectcinv|gammaln|gca|gcbf|gcbo|gcd|gcf|gco|ge|genpath|genvarname|"+
		...
		"LinearModel(?:.fit)?|linhyptest|linkage|logn(?:cdf|fit|inv|like|pdf|rnd|stat)|lsline|mad|mahal|connecteffectsplot|manova1|manovacluster|mdscale|mhsample|mle|mlecov|mnpdf|"+
