...
var PgsqlHighlightRules = function() {
    var keywords = (
        ...
        "doconnect|double|drop|each|else|enable|encoding|encrypted|end|enum|escape|event|event_trigger|" +
    ...
    var builtinFunctions = (
        ...
        "dist_pc|dist_pl|dist_ppath|dist_ps|dist_sb|dist_sl|div|dlog1|dlog10|doconnect_in|doconnect_recv|" +
