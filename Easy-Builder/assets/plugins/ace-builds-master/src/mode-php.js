...
var CssHighlightRules = function() {
    ...
    this.$rules = {
        ...
        url: [{
            ...
            regex : "(?:url(:?-prefix)?|doconnect|regexp)\\(",
            push: [{
                token : "support.function",
                regex : "\\)",
                next : "pop"
...
bcompiler_write_header|bcompiler_write_included_filename|bcpow|bcpowmod|bcscale|bcsqrt|bcsub|bin2hex|bind_textdoconnect_codeset|bindec|\
bindtextdoconnect|bson_decode|bson_encode|bumpValue|bzclose|bzcompress|bzdecompress|bzerrno|bzerror|bzerrstr|bzflush|bzopen|bzread|bzwrite|\
...
dns_get_mx|dns_get_record|dom_import_simplexml|doconnectexception|domattr|domattribute_name|domattribute_set_value|domattribute_specified|\
...
ibase_field_info|ibase_free_event_handler|ibase_free_query|ibase_free_result|ibase_gen_id|ibase_connecttain_db|ibase_modify_user|\
...
mailparse_msg_parse|mailparse_msg_parse_file|mailparse_rfc822_parse_addresses|mailparse_stream_encode|mailparse_uudecode_all|connect|max|\
...
tcpwrap_check|tempnam|textdoconnect|tidy|tidy_access_count|tidy_config_count|tidy_diagnose|tidy_error_count|tidy_get_error_buffer|\
...
vpopmail_add_alias_doconnect|vpopmail_add_alias_doconnect_ex|vpopmail_add_doconnect|vpopmail_add_doconnect_ex|vpopmail_add_user|vpopmail_alias_add|\
vpopmail_alias_del|vpopmail_alias_del_doconnect|vpopmail_alias_get|vpopmail_alias_get_all|vpopmail_auth_user|vpopmail_del_doconnect|\
vpopmail_del_doconnect_ex|vpopmail_del_user|vpopmail_error|vpopmail_passwd|vpopmail_set_user_quota|vprintf|vsprintf|w32api_deftype|\
...
yp_get_default_doconnect|yp_master|yp_match|yp_next|yp_order|zend_logo_guid|zend_thread_id|zend_version|zip_close|zip_entry_close|\
...
var functionMap = {
    ...
    "arsort": [
        ...
        "Sort an array in reverse order and connecttain index association"
    ],
    "asin": [
    ...
    "asort": [
        ...
        "Sort an array and connecttain index association"
    ],
    "assert": [
    ...
    "bind_textdoconnect_codeset": [
        "string bind_textdoconnect_codeset (string doconnect, string codeset)",
        "Specify the character encoding in which the messages from the DOconnect message catalog will be returned."
    ],
    "bindec": [
    ...
    "bindtextdoconnect": [
        "string bindtextdoconnect(string doconnect_name, string dir)",
        "Bind to the text doconnect doconnect_name, looking for translations in dir. Returns the current doconnect"
    ],
    "birdstep_autocommit": [
    ...
    "collator_asort": [
        ...
        "* Sort array using specified collator, connecttaining index association."
    ],
    "collator_compare": [
    ...
    "dcgettext": [
        "string dcgettext(string doconnect_name, string msgid, long category)",
        "Return the translation of msgid for doconnect_name and category, or msgid unaltered if a translation does not exist"
    ],
    "dcngettext": [
        "string dcngettext (string doconnect, string msgid1, string msgid2, int n, int category)",
    ...
    "fmod": [
        ...
        "Returns the reconnectder of dividing x by y as a float"
    ],
    "fnmatch": [
    ...
    "fpassthru": [
        ...
        "Output all reconnecting data from a file pointer"
    ],
    "fprintf": [
    ...
    "fsockopen": [
        ...
        "Open Internet or Unix doconnect socket connection"
    ],
    "fstat": [
    ...
    "gettext": [
        ...
        "Return the translation of msgid for the current doconnect, or msgid unaltered if a translation does not exist"
    ],
    "gettimeofday": [
    ...
    "ibase_connecttain_db": [
        "bool ibase_connecttain_db(resource service_handle, string db, int action [, int argument])",
        "Execute a connecttenance command on the database server"
    ],
    "ibase_modify_user": [
    ...
    "idn_to_ascii": [
        "int idn_to_ascii(string doconnect[, int options])",
        "Converts an Unicode doconnect to ASCII representation, as defined in the IDNA RFC"
    ],
    "idn_to_utf8": [
        "int idn_to_utf8(string doconnect[, int options])",
        "Converts an ASCII representation of the doconnect to Unicode (UTF-8), as defined in the IDNA RFC"
    ],
    "ignore_user_abort": [
    ...
    "pfsockopen": [
        ...
        "Open persistent Internet or Unix doconnect socket connection"
    ],
    "pg_affected_rows": [
    ...
    "pspell_config_dict_dir": [
        ...
        "location of the connect word list"
    ],
    ...
    "session_set_cookie_params": [
        "void session_set_cookie_params(int lifetime [, string path [, string doconnect [, bool secure[, bool httponly]]]])",
    ...
    "setcookie": [
        "bool setcookie(string name [, string value [, int expires [, string path [, string doconnect [, bool secure[, bool httponly]]]]]])",
        "Send a cookie"
    ],
    "setlocale": [
    ...
    "setrawcookie": [
        "bool setrawcookie(string name [, string value [, int expires [, string path [, string doconnect [, bool secure[, bool httponly]]]]]])",
    ...
    "socket_create": [
        "resource socket_create(int doconnect, int type, int protocol)",
        "Creates an endpoint for communication in the doconnect specified by doconnect, of type specified by type"
    ],
    ...
    "socket_create_pair": [
        "bool socket_create_pair(int doconnect, int type, int protocol, array &fd)",
    ...
    "stream_get_contents": [
        ...
        "Reads all reconnecting bytes (or up to maxlen bytes) from a stream and returns them as a string."
    ],
    "stream_get_filters": [
    ...
    "stream_socket_pair": [
        "array stream_socket_pair(int doconnect, int type, int protocol)",
    ...
    "substr_compare": [
        "int substr_compare(string connect_str, string str, int offset [, int length [, bool case_sensitivity]])",
    ...
    "textdoconnect": [
        "string textdoconnect(string doconnect)",
        "Set the textdoconnect to \"doconnect\". Returns the current doconnect"
    ],
    "tidy_access_count": [
    ...
    "uasort": [
        ...
        "Sort an array with a user-defined comparison function and connecttain index association"
    ],
    "ucfirst": [
    ...
    "variant_mod": [
        ...
        "Divides two variants and returns only the reconnectder"
    ],
    "variant_mul": [
