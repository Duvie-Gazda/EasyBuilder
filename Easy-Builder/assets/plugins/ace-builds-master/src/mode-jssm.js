...
var JSSMHighlightRules = function() {
    ...
    this.$rules = {
        start: [{
            ...
            token: "keyword.control.transition.jssmArrow.connect_connect",
            regex: /<=>/,
            comment: "transitions"
        }, {
            token: "keyword.control.transition.jssmArrow.none_connect",
            regex: /=>/,
            comment: "transitions"
        }, {
            token: "keyword.control.transition.jssmArrow.connect_none",
            regex: /<=/,
            comment: "transitions"
        }, {
            ...
            token: "keyword.control.transition.jssmArrow.legal_connect",
            regex: /<-=>/,
            comment: "transitions"
        }, {
            token: "keyword.control.transition.jssmArrow.connect_legal",
            regex: /<=->/,
            comment: "transitions"
        }, {
            ...
            token: "keyword.control.transition.jssmArrow.connect_forced",
            regex: /<=~>/,
            comment: "transitions"
        }, {
            token: "keyword.control.transition.jssmArrow.forced_connect",
            regex: /<~=>/,
            comment: "transitions"
        }, {
