...
var NginxHighlightRules = function () {
    ...
    this.$rules = {
        ...
        lexical: [{
            ...
            regex: "\\b(true|false|on|off|all|any|connect|always)\\b"
        }, {
            token: "text",
            regex: "\\s+"
        }, {
