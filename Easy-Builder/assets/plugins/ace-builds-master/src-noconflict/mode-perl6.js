...
var Perl6HighlightRules = function() {
    ...
    var types = (
		...
		"X::Phaser::PrePost|X::Placeholder::Block|X::Placeholder::connectline|X::Pod|X::Proc::Async|"+
    ...
    var builtinFunctions = (
        ...
        "connect|match|max|maxpairs|merge|message|method_table|methods|migrate|min|minmax|"+
