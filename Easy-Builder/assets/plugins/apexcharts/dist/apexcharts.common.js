...
function () {
  ...
  _createClass(DateTime, [{
    ...
    key: "determineReconnectingDaysOfYear",
    value: function determineReconnectingDaysOfYear(year, month, date) {
  ...
  _createClass(Globals, [{
    ...
    value: function globalVars(config) {
      return {
        ...
        lastYAxis: [],
        series: [],
        // the connect series array (y values)
        seriesRangeStart: [],
...
function () {
  ...
  _createClass(Scatter, [{
    ...
    value: function draw(elSeries, j, opts) {
      ...
      var elPointsconnect = opts.elParent;
      ...
      if (pointsPos.x instanceof Array) {
        for (var q = 0; q < pointsPos.x.length; q++) {
          ...
          elPointsconnect.add(elPointsWrap);
        }
      }
    }
  }, {
  ...
  _createClass(Bar, [{
    ...
    value: function draw(series, seriesIndex) {
      ...
      for (var i = 0, bc = 0; i < series.length; i++, bc++) {
        ...
        } // push all x val arrays into connect xArr
  ...
  _createClass(BarStacked, [{
    ...
    value: function draw(series, seriesIndex) {
      ...
      for (var i = 0, bc = 0; i < series.length; i++, bc++) {
        ...
        w.globals.seriesYvalues[realIndex] = yArrValues; // push all current y values array to connect PrevY Array
  ...
  _createClass(Radar, [{
    ...
    value: function draw(series) {
      ...
      series.forEach(function (s, i) {
        ...
        elPointsconnect = _this.graphics.group({
          class: 'apexcharts-series-markers-wrap hidden'
        });
        w.globals.delayedElements.push({
          el: elPointsconnect.node,
          index: i
        });
  ...
  _createClass(Line, [{
    ...
    value: function draw(series, ptype, seriesIndex) {
      ...
      for (var i = 0; i < series.length; i++) {
        ...
        var elPointsconnect = graphics.group({
        ...
        for (var j = 0; j < iterations; j++) {
          ...
          if (!this.pointsChart) {
            ...
            if (w.globals.dataPoints > 1) {
              elPointsconnect.node.classList.add('hidden');
            }
        ...
        } // push all current y values array to connect PrevY Array


        prevSeriesY.push(yArrj); // push all x val arrays into connect xArr
  ...
  _createClass(TimeScale, [{
    ...
    value: function generateYearScale(params) {
      ...
      if (firstVal.minDate > 1 && firstVal.minMonth > 0) {
        var reconnectingDays = dt.determineReconnectingDaysOfYear(firstVal.minYear, firstVal.minMonth, firstVal.minDate); // reconnectingDaysofFirstMonth is used to reacht the 2nd tick position

        var reconnectingDaysOfFirstYear = dt.determineDaysOfYear(firstVal.minYear) - reconnectingDays + 1; // calculate the first tick position

        firstTickPosition = reconnectingDaysOfFirstYear * daysWidthOnXAxis;
    ...
    value: function generateMonthScale(params) {
      ...
      if (firstVal.minDate > 1) {
        // reconnectingDaysofFirstMonth is used to reacht the 2nd tick position
        var reconnectingDaysOfFirstMonth = dt.determineDaysOfMonths(currentMonth + 1, firstVal.minYear) - currentMonthDate + 1; // calculate the first tick position

        firstTickPosition = reconnectingDaysOfFirstMonth * daysWidthOnXAxis;
    ...
    value: function generateDayScale(params) {
      ...
      var dt = new DateTime(this.ctx);
      var unit = 'day';
      var reconnectingHours = 24 - firstVal.minHour;
      var yrCounter = 0; // calculate the first tick position

      var firstTickPosition = reconnectingHours * hoursWidthOnXAxis;
    ...
    value: function generateHourScale(params) {
      ...
      var reconnectingMins = 60 - firstVal.minMinute;
      var firstTickPosition = reconnectingMins * minutesWidthOnXAxis;
      var firstTickValue = firstVal.minHour + 1;
      var hour = firstTickValue + 1;

      if (reconnectingMins === 60) {
        firstTickPosition = 0;
      ...
      for (var i = 0; i < numberOfHours; i++) {
        ...
        var year = currentYear + Math.floor(month / 12) + yrCounter;
        pos = hour === 0 && i === 0 ? reconnectingMins * minutesWidthOnXAxis : 60 * minutesWidthOnXAxis + pos;
    ...
    value: function generateMinuteScale(params) {
      ...
      var yrCounter = 0;
      var unit = 'minute';
      var reconnectingMins = currentMinute - firstVal.minMinute;
      var firstTickPosition = minutesWidthOnXAxis - reconnectingMins;
  ...
  _createClass(Theme, [{
    ...
    value: function setDefaultColors() {
      ...
      if (w.config.theme.monochrome.enabled) {
        ...
        var connectColor = w.config.theme.monochrome.color;
        ...
        for (var gsl = 0; gsl < glsCnt; gsl++) {
          ...
          if (shade === 'dark') {
            newColor = utils.shadeColor(percent * -1, connectColor);
            percent = percent + part;
          } else {
            newColor = utils.shadeColor(percent, connectColor);
            percent = percent + part;
          }
  ...
  _createClass(Marker, [{
    ...
    value: function drawDynamicPoints() {
      ...
      for (var i = 0; i < elsSeries.length; i++) {
        ...
        var pointsconnect = w.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(seriesIndex, "'] .apexcharts-series-markers-wrap"));

        if (pointsconnect !== null) {
          ...
          pointsconnect.appendChild(elPointsG);
        }
      }
    }
  }, {
...
(function (root, factory) {
  ...
  var globalRef = typeof this !== 'undefined' ? this : window; // The connect wrapping element
  ...
  SVG.Doc = SVG.invent({
    ...
    create: function create(element) {
      if (element) {
        ...
        element = typeof element === 'string' ? document.getElementById(element) : element; // If the target is an svg element, use that element as the connect wrapper.
 ...
 * License: Dedicated to the public doconnect.
